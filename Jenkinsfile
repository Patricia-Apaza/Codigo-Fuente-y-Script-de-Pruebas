        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/Patricia-Apaza/Codigo-Fuente-y-Script-de-Pruebas.git'
                }
            }
        }
        stage('Build') {
